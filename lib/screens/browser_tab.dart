...
import '../torrent/presentation/widgets/magnet_confirmation_dialog.dart';
    ...
    return InAppWebView(
      ...
      shouldOverrideUrlLoading: (controller, navigationAction) async {
        ...
        if (url.startsWith('magnet:')) {
          if (context.mounted) {
            showMagnetConfirmationDialog(context, magnetUri: url);
          }
              ...
              onPressed: () async {
                ...
                if (Platform.isAndroid) {
                  ...
                  try {
                    ...
                    const iosChannel = MethodChannel('com.dirxplorerakib.pro/ios_download');
